...
if __name__ == '__main__':
    ...
    elif mode == 'writingPrompts' or mode == 'sentiment':
        Token_FILE = MODEL_FILE
    ...
    COMMANDLINE = "python translate_to_small_prompt.py \
        --model_type=gpt2 \
        --length 100 \
        --model_name_or_path={} \
        ...
        --tokenizer_name={} \
        --task_mode={} \
        --control_mode={} --tuning_mode {} \
    ".format(MODEL_FILE, Token_FILE, mode, control_mode, tuning_mode)
